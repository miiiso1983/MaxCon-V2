    ...
    public function store(Request $request)
    {
        ...
        try {
            ProductRecall::create([
                ...
                'recall_coordinator' => $request->recall_coordinator,
