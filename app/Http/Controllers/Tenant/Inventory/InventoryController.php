    ...
    public function downloadTemplate()
    {
        try {
            ...
            $csvData = [
                ...
                ['NEW001', 'منتج اختبار جديد', 'MAIN-004', '25', '15.50', '22.00', 'A-01-01', 'BATCH001', '2025-12-31', 'active', 'منتج جديد سيتم إنشاؤه تلقائي<|im_start|>'],
                ['NEW002', 'دواء جديد للاختبار', '005', '50', '12.00', '18.00', 'B-02-01', 'BATCH002', '2026-06-30', 'active', 'دواء جديد للاختبار'],
                ['PRD000002', 'تحديث منتج موجود', 'MAIN-004', '30', '10.00', '15.00', 'A-01-03', 'BATCH003', '2026-12-31', 'active', 'تحديث مخزون منتج موجود'],
                ['', '', '', '', '', '', '', '', '', '', ''],
                ['ملاحظات مهمة:', '', '', '', '', '', '', '', '', '', ''],
                ['1. استخدم أكواد منتجات جديدة (مثل NEW001) لإنشاء منتجات جديدة', '', '', '', '', '', '', '', '', '', ''],
                ['2. استخدم أكواد منتجات موجودة (مثل PRD000002) لتحديث المخزون', '', '', '', '', '', '', '', '', '', ''],
                ['3. أكواد المستودعات المتاحة: MAIN-004, 005', '', '', '', '', '', '', '', '', '', ''],
                ['4. الحالات المتاحة: active, quarantine, damaged, expired', '', '', '', '', '', '', '', '', '', ''],
                ['5. تنسيق التاريخ: YYYY-MM-DD (مثل 2025-12-31)', '', '', '', '', '', '', '', '', '', ''],
            ];
