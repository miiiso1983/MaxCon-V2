...
class CreatePurchaseOrdersTables extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'purchase-orders:create-tables';
     ...
     * @var string
     */
    protected $description = 'Create purchase orders and purchase order items tables';
    ...
    {
        $this->info('Creating purchase orders tables...');

        try {
            // Check if purchase_orders table exists
            if (!Schema::hasTable('purchase_orders')) {
                $this->info('Creating purchase_orders table...');
                ...
                $this->info('✅ purchase_orders table created successfully!');
            } else {
                $this->info('✅ purchase_orders table already exists.');
            }

            // Check if purchase_order_items table exists
            if (!Schema::hasTable('purchase_order_items')) {
                $this->info('Creating purchase_order_items table...');
                ...
                $this->info('✅ purchase_order_items table created successfully!');
            } else {
                $this->info('✅ purchase_order_items table already exists.');
            }

            $this->info('🎉 All purchase orders tables are ready!');

            // Test the tables
            $this->info('Testing tables...');
            $this->info('purchase_orders table exists: ' . (Schema::hasTable('purchase_orders') ? 'YES' : 'NO'));
            $this->info('purchase_order_items table exists: ' . (Schema::hasTable('purchase_order_items') ? 'YES' : 'NO'));
