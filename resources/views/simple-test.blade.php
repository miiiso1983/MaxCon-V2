...
<body>
    ...
    <p><a href="/test-excel-form" style="background: #20c997; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px; margin-right: 10px;">اختبار رفع ملف Excel</a></p>
    <p><a href="/force-import-test" style="background: #e83e8c; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px;">اختبار إنشاء منتج مباشر</a></p>
    <p style="font-size: 12px; color: #666;">
        ...
        الزر الأخضر الفاتح سيفتح صفحة اختبار رفع ملف Excel مع تفاصيل مفصلة<br>
        الزر الوردي سيختبر إنشاء منتج مباشرة في قاعدة البيانات
    </p>
