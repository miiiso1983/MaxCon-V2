...
<div style="padding: 30px; background: linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%); min-height: 100vh;">
    ...
    <div style="background: rgba(255,255,255,0.95); border-radius: 20px; padding: 30px; margin-bottom: 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.1); backdrop-filter: blur(10px);">
        <div style="display: flex; align-items: center; justify-content: between; margin-bottom: 20px;">
            ...
            <div style="display: flex; gap: 15px;">
                <a href="{{ route('tenant.inventory.regulatory.recalls.index') }}" style="background: rgba(255,255,255,0.2); color: #ff9a9e; padding: 15px 25px; border: 2px solid #ff9a9e; border-radius: 15px; font-weight: 600; display: flex; align-items: center; gap: 10px; text-decoration: none;">
    ...
    <div style="background: rgba(255,255,255,0.95); border-radius: 20px; padding: 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.1); backdrop-filter: blur(10px);">
        <form action="{{ route('tenant.inventory.regulatory.recalls.store') }}" method="POST" id="recallForm">
            @csrf
            ...
            <div style="display: flex; gap: 15px; justify-content: center; padding-top: 20px; border-top: 2px solid #e2e8f0;">
                ...
                <a href="{{ route('tenant.inventory.regulatory.recalls.index') }}" 
