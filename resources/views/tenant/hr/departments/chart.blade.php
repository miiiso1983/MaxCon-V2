...
<div style="padding: 30px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh;">
    ...
    <div style="background: rgba(255,255,255,0.95); border-radius: 20px; padding: 25px; margin-bottom: 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.1); backdrop-filter: blur(10px);">
        <div style="display: flex; gap: 15px; align-items: center; flex-wrap: wrap;">
            ...
            <button onclick="exportChart()" style="background: #ed8936; color: white; padding: 10px 15px; border: none; border-radius: 8px; font-weight: 600; cursor: pointer;">
...
function exportChart() {
    alert('ميزة تصدير الهيكل التنظيمي قيد التطوير\n\nسيتم إضافة:\n• تصدير كصورة PNG/JPG\n• تصدير كملف PDF\n• تصدير كملف Excel\n• تصدير تفاعلي HTML');
}
