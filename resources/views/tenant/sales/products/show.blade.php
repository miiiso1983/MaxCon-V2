    ...
    <div class="content-card">
        ...
        <div style="space-y: 15px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px; background: {{ $isLowStock ? '#fef2f2' : '#f0fdf4' }}; border-radius: 8px; margin-bottom: 10px;">
                <span style="color: {{ $isLowStock ? '#dc2626' : '#16a34a' }}; font-weight: 600;">المخزون الحالي</span>
                <span style="color: {{ $isLowStock ? '#b91c1c' : '#15803d' }}; font-weight: 700;">{{ $currentStock }} {{ $unit }}</span>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px; background: #fffbeb; border-radius: 8px; margin-bottom: 10px;">
                ...
                <span style="color: #92400e; font-weight: 700;">{{ $minStock }} {{ $unit }}</span>
            </div>
